...
# Сюда требуется еще проверка на наличие такого слова в языке, как сделать эту проверку, не знаю. Надо подключать наверно какие словари
eng = {1:'AEIOULNSTR',
      	2:'DG',
      	3:'BCMP',
      	4:'FHVWY',
...
if N == 1:
    ...
    print('Такого слова нет в этом языке!!!')